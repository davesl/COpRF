function [timeframes,timekeys,digitrecord,trialoffsets] = ...
  ptviewmovie(images,frameorder,framecolor,frameduration,fixationorder,fixationcolor,fixationsize, ...
              ...
              triggerfun,framefiles,frameskip,triggerkey,specialcon,trialtask,maskimages,specialoverlay,dummy_pause)
...
disablekey = KbName('5%'); % name of the key you want to remove for the checking function (here the signal trigged by the scanner)
...
DisableKeysForKbCheck(disablekey); % with this function, the next time you will you use   [keyIsDown,key_seconds,keyCode] = KbCheck, the kbCheck function will check for all keys but not the key 5%. 
